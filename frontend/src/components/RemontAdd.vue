          ...
          <div class="modal-body">
            ...
            <form v-else class="add-remont__cont" action="javascript:void(0);">
              ...
              <label for="add-remont-parent">
                ...
                <small>(н-р, замена тормозных колодок относится к ремонту колеса, которая в свою очередь относится к ремонту ходовки и т.д. Смотря что уже было добавлено.) </small> <br/>
                НЕ обязательно
